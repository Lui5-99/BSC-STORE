...
namespace BSC.Business.Services
{
    public class ProductService(AppDbContext context) : IProductService
    {
        ...
        )
        {
            ...
            var query = _context.Product.Include(p => p.Inventory).AsQueryable();
        ...
        public async Task<IEnumerable<Product>> GetAllToSearch() =>
            await _context.Product.Include(i => i.Inventory).ToListAsync();

        public async Task<Product?> GetByIdAsync(int id) =>
            await _context
                .Product.Include(p => p.Inventory)
        ...
        public async Task<Product> UpdateAsync(Product product, int? newQuantity = null)
        {
            ...
            if (newQuantity.HasValue)
                product.Inventory = await _context.Inventory.FirstOrDefaultAsync(i =>
                    i.ProductId == product.ProductId
                )!;
